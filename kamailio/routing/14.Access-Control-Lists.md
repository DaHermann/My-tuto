...
Le mécanisme de la LCA présenté dans cette section a l'inconvénient de nécessiter des outils de gestion personnalisés (par exemple, kamctl ou siremis doivent être personnalisés pour ajouter/supprimer/mettre à jour les nouvelles colonnes).
